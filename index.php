<?php 
  ...
  if (isset($_SESSION[id])){
      if ($_SESSION[level]=='superuser'){
          $iden = mysql_fetch_array(mysql_query("SELECT * FROM db_users where id_user='$_SESSION[id]'"));
           $nama =  $iden[nama_lengkap];
           $level = 'Administrator';
           $foto = 'dist/img/download.jpg';
      }elseif($_SESSION[level]=='kepala'){
          $iden = mysql_fetch_array(mysql_query("SELECT * FROM db_users where id_user='$_SESSION[id]'"));
            $gu = mysql_fetch_array(mysql_query("SELECT * FROM db_guru where nip='$iden[username]'"));
           $nama =  $iden[nama_lengkap];
          ...
          $iden = mysql_fetch_array(mysql_query("SELECT * FROM db_guru where nip='$_SESSION[id]'"));
           $nama =  $iden[nama_guru];
           $level = 'Guru / Pengajar';
           if (trim($iden[foto])==''){
              $foto = 'foto_siswa/no-image.jpg';
          ...
          $iden = mysql_fetch_array(mysql_query("SELECT * FROM db_siswa where nisn='$_SESSION[id]'"));
           $nama =  $iden[nama];
           $level = 'Siswa / Murid';
           if (trim($iden[foto])==''){
              $foto = 'foto_siswa/no-image.jpg';
...
<html>
  <head>
    ...
    <title> SIAKAD SMK AL WASHLIYAH</title>
